# Kava Evm Token Creation Tool

A simple frontend tool to create tokens on the Kava Evm (KAVA) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Kava-Evm-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Kava Evm Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Kava-Evm-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Kava Evm wallet address for receiving fees. Also set fee in KAVA that you want to charge
